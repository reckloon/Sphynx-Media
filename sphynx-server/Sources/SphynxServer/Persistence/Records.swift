...
struct ItemRecord: Codable, Sendable, FetchableRecord, PersistableRecord {
    ...
    var placeholderURL: String?
    /// A BlurHash for the poster placeholder, generated by the low-res-images
    /// extension when its mode is `blurhash`. nil until generated (serving then
    /// falls back to the URL placeholder).
